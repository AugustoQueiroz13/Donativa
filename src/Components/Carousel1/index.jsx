                            ...
                            <div className="row row-cols-1 row-cols-md-3 g-4">
                                ...
                                <div className="col">
                                    <div className="card card-text p-2">
                                        ...
                                        <div><Link target="_blank" to="/Doar" type="button"
                            ...
                            <div className="row row-cols-1 row-cols-md-3 g-4">
                                <div className="col">
                                    <div className="card  card-text p-2">
                                        ...
                                        <div className="texto-card">
                                            <h5>Periféricos</h5>
                                            <p>Coisas simples para alguns, para outros são Link chave para o futuro; mouses, teclados, webcams e fones estão na lista de mais requisitados</p>
                                        </div>
                                        <div><Link target="_blank" to="/Doar" type="button" className="btn btn-dark">Clique
                                            para doar</Link></div>
                                    </div>
                                </div>
                                <div className="col">
                                    <div className="card  card-text p-2">
                                        ...
                                        <div className="texto-card">
                                            ...
                                            <p> Sabemos o poder transformador da educação, por isso bolsas de estudos em cursos online ou presenciais também podem ser doados</p>
                                        </div>
                                        <div><Link target="_blank" to="/Doar" type="button" className="btn btn-dark">Clique
                                            para doar</Link>
                                        </div>
